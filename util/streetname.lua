...
local MP = minetest.get_modpath("mapblock_tileset_city")
...
function mapblock_tileset_city.get_street_name(rnd_num)
...
minetest.register_chatcommand("streetname", {
	func = function(_, p)
		return true, mapblock_tileset_city.get_street_name(tonumber(p))
	end
})
